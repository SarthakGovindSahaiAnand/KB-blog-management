...
// import SearchIcon from '@mui/icons-material/Search'; // Not used, consider removing if not needed
...
function CreatePost() {
    ...
    const [category, setCategory] = useState(''); // New state for blog category
    ...
    const { currentUser, createBlog, isAdmin, listBlogCategories } = useAuth(); // isAdmin is now from AuthContext

    useEffect(() => {
      const fetchCategories = async () => {
        try {
          const fetchedCategories = await listBlogCategories();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setError("");
            setLoading(true);
            await createBlog(headingRef.current.value, subHeadingRef.current.value, blogContent, category);
